      ...
      <div class="row">
         ...
         <div class="twelve columns">
            ...
            <ul class="social-links">
               <li><a href="https://<?php echo $informations->facebook; ?>"><i class="fa fa-facebook"></i></a></li>
               <li><a href="https://<?php echo $informations->twitter; ?>"><i class="fa fa-twitter"></i></a></li>
               <li><a href="https://<?php echo $informations->gplus; ?>"><i class="fa fa-google-plus"></i></a></li>
