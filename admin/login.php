...
<html lang="en">
    <head> 
		...
		<link rel="shortcut icon" href="../images/admin-login.png" >
	...
	<body>
		...
		<p>Let's start addding experiences.</p>
		<br>
		<p>*Note*<br>
			Please consult with admin by sending message for admin authentication.</p>
		</div><!--col-sm-6-->
